CLASS zcl_fill_s4d0044_flights DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_fill_s4d0044_flights IMPLEMENTATION.
...
*Add 50 new connection numbers and 2000 days of flights for each
    ...
    INSERT zs4d0044flights FROM TABLE @insert_tab.
